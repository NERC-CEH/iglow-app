...
import { map, calendar, clipboard, time, sunny, thermometer, female, male, paw, pin, flask, flower, flashlight} from 'ionicons/icons';
    ...
    return (
      <IonContent id="record-edit">
        <IonList lines="full">
          ...
          <IonItem routerLink={`/record/${sample.cid}/edit/temp`} detail>
